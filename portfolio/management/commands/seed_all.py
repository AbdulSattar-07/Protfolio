    ...
    def seed_profile(self):
        Profile.objects.update_or_create(
            ...
            defaults={
                ...
                'current_position': 'Currently Working at RoyalSoft',
...
I have successfully deployed production-ready AI solutions including an enterprise chatbot at RoyalSoft that provides bilingual support for ERP systems. My technical skills include working with modern frameworks like TensorFlow, PyTorch, and Transformers, as well as building scalable APIs with FastAPI.
...
I am passionate about solving complex problems using AI and continuously learning new technologies to stay at the forefront of this rapidly evolving field.''',
    ...
    def seed_site_settings(self):
        SiteSettings.objects.update_or_create(
            id=1,
            defaults={
                'site_name': 'Abdul Sattar Portfolio',
                ...
                'site_keywords': 'AI Engineer, Machine Learning, Deep Learning, NLP, Computer Vision, Python, TensorFlow, PyTorch',
                'contact_email': 'malikabdulsattar9947@gmail.com',
                'github_url': 'https://github.com/AbdulSattar-07',
                'linkedin_url': 'https://linkedin.com/in/abdul-sattar',
                'twitter_url': 'https://twitter.com/abdulsattar',
                'kaggle_url': 'https://kaggle.com/abdulsattar',
                'whatsapp_url': 'https://wa.me/923001234567?text=Hi%20Abdul%2C%20I%20would%20like%20to%20discuss%20a%20project',
